...
export default function RoomError() {
    ...
    console.log(parsedErr, error?.data);
            ...
            <main className="min-h-screen p-10 flex w-full items-center justify-center text-center">
                <div className="">
                    ...
                    <div className="flex gap-3 flex-wrap items-center justify-center">
                        ...
                        <h3><button onClick={reloadPage} className="px-4 inline-block py-2 font-semibold rounded text-[var(--terColor)] bg-[var(--mainColor)]">Retry</button></h3>
                        {
