...
export default function RummyCardsBox({ className }) {
    ...
    return (
        ...
        <div className="relative">
            <MatchCountDown />
            <MatchEndTimer />
            <MainBox className={`bg-[rgba(0,0,0,0.3)] overflow-hidden items-center px-6 pt-6 pb-2 flex z-10 gap-4 relative${className ? " " + className : ""}`}> 
                <LoaderBox loaderType="MatchCards" />
                <div className="img_wrapper max-w-24 relative">
                    <img src="/cards/empty-card.png" alt="Empty card" loading="eager" />
                    <div className="absolute left-16 z-0 top-1/2 -translate-y-1/2 max-w-24 w-full rotate-90">
                ...
                <div className="img_wrapper max-w-24 relative w-full h-full">
